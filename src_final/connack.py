from pachet import *
from pachet import MQTTPacket, FixedHeader,VariableHeader
from packettype import CONNACK
...
class ConnackPacket(MQTTPacket):
    ...
    def __init__(self, fixed : FixedHeader = None, variable : ConnackVariable = None, payload = None):
        if fixed is None :
            h = FixedHeader(CONNACK, 0x00)
        else:
