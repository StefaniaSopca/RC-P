...
class FixedHeader:
    ...
    def to_bytes(self):
        ...
        try:
            ...
            raise Exception('packet_type encoding exceed 1 byte length: value=%d', packet_type)
...
class MQTTPacket:
    ...
    def __init__(self, fixed: FixedHeader, variable_header: VariableHeader = None, payload: Payload = None):
